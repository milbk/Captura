...
namespace DesktopDuplication
{
    public class MfWriter : IVideoFileWriter
    {
        ...
        public MfWriter(int Fps, int Width, int Height, string FileName)
        {
            ...
            devMan.ResetDevice(DeviceMan.Device);
        ...
        {
            if (Image is TextureFrame frame)
            {
                Write(frame.Texture.Sample);
            }
            else if (Image is IFrameWrapper wrapper && wrapper.Frame is TextureFrame textureFrame)
            {
                Write(textureFrame.Texture.Sample);
            }
        }
